...
| Layer | Path | Purpose |
|-------|------|---------|
| Product Plan | `planning-mds/features/F0010-dashboard-opportunities-refactor/PRD.md` | Feature goals and scope |
| Stories | `planning-mds/features/F0010-dashboard-opportunities-refactor/F0010-S*.md` | Testable story slices |
